...
import { adicionarItemInv } from "../componentes/ListaAdc";

const windowWidth = Dimensions.get('window').width;
const windowHeight = Dimensions.get("window").height;
export default function PlantaDetalhes({route}){
    ...
    <SafeAreaView style={{minHeight: '100%'}}>
        ...
        <Texto style={estilos.subtitulo}>LOCALIZAÇÃO DA PLANTA: </Texto>
        ...
        <View style={estilos.botoes}>
            ...
            <TouchableOpacity style={estilos.botao} onPress={()=> {
                adicionarItem({nome: plantaNome,  imagem: plantaNomeCientifico}); 
                adicionarItemInv({nome: plantaNome, imagem: plantaNomeCientifico});
